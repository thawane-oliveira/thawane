...
function Home() {
  return (
    <div className='h-screen w-screen overflow-auto flex items-center justify-center container mx-auto -m-10'>
      <div className='bg-yellow-50 h-2/4 w-4/5 shadow-lg shadow-violet-400 py-4 px-6 mx-4 rounded-md'>
